...
root_out = string(main,"/out/")
snap = [21, 21, 21]   #...smaple of list of ENZO snapshots to be used (they can even repeat)
#...link for one sample catalog of halos: https://owncloud.ia2.inaf.it/index.php/s/7S9QsvSgyq45OXh 
#...link for one sample ENZO 3D dataset: https://owncloud.ia2.inaf.it/index.php/s/F5bFCRkDIe6llcX
zeds = [1.0, 0.5, 0.0]   #...list of redshits associated with each snapshots. 
nz = size(zeds)
...
@everywhere sim = "MAKITRA"   #...or sim="MAKITRA"  it switched between slightly different conventions for galaxy catalogs, used in these different generations of simulations
